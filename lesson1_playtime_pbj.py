...
if bread > 2 and pb > 1 and jelly > 1:
	print "I can make a peanut butter and jelly sandwhich."
else:
...
if bread > 2 and pb > 1 and jelly >1:
	print "I can make this many sandwiches: {0}".format(bread / 2)
else: 
	print "Looks like I don't have a lunch today"
...
if bread % 2 and pb % 2 and jelly % 2:
...
if bread < 2:
	...
	print "I have all the ingredients I need!"